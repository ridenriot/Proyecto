...
namespace projecto_final
{
	partial class Eliminarbeb
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Ingresa el ID a Eliminar:";
			...
			this.Name = "Eliminarbeb";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Eliminarbeb";
			this.Load += new System.EventHandler(this.EliminarbebLoad);
